...
export const LandingPage: React.FC<LandingPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="w-full bg-slate-50 overflow-hidden">
      ...
      {/* ========================================================= */}
      <section className="relative pt-12 pb-20 md:pt-16 md:pb-28 overflow-hidden bg-gradient-to-b from-white via-brand-50/20 to-slate-50">
        {/* Soft background glow spots */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-brand-200/25 blur-[120px] rounded-full pointer-events-none" />
        <div className="absolute top-1/3 left-1/4 w-[300px] h-[300px] bg-sky-200/20 blur-[100px] rounded-full pointer-events-none" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-brand-200/80 shadow-soft text-brand-700 text-xs font-semibold mb-6">
            <span className="w-2 h-2 rounded-full bg-brand-500 animate-ping" />
            <span>Next-Generation Learning & Training Platform</span>
          </div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-brand-600 hover:bg-brand-700 text-white font-semibold text-base shadow-soft hover:shadow-glow transition duration-200 flex items-center justify-center gap-2 group"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-white hover:bg-slate-100 text-slate-800 font-semibold text-base border border-slate-200 shadow-soft transition duration-200"
            >
              Get Started
            </button>
          </div>

          {/* Mini Interactive Tip */}
          <p className="mt-3 text-xs text-slate-400 font-mono">
            Hover cursor over the CAPACITY text to interact with the particle physics
          </p>

          {/* Platform Stats Strip */}
          <div className="mt-14 pt-8 border-t border-slate-200/60 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <p className="text-3xl font-extrabold text-slate-900">100%</p>
              <p className="text-xs text-slate-500 font-medium mt-0.5">Self-Contained & Local</p>
            </div>
            <div>
              <p className="text-3xl font-extrabold text-brand-600">3 Roles</p>
              <p className="text-xs text-slate-500 font-medium mt-0.5">Trainee • Trainer • Admin</p>
            </div>
            <div>
              <p className="text-3xl font-extrabold text-sky-600">Automated</p>
              <p className="text-xs text-slate-500 font-medium mt-0.5">Assessments & Scores</p>
            </div>
            <div>
              <p className="text-3xl font-extrabold text-emerald-600">Verifiable</p>
              <p className="text-xs text-slate-500 font-medium mt-0.5">Accredited Certificates</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1: Trainee */}
            <div className="group bg-slate-50 hover:bg-white rounded-2xl p-8 border border-slate-200/80 hover:border-sky-300 shadow-soft hover:shadow-soft-lg transition-all duration-300 flex flex-col justify-between">
              <div>
              ...
              <button
                ...
                className="w-full py-2.5 px-4 rounded-xl bg-white group-hover:bg-sky-600 text-slate-800 group-hover:text-white font-medium text-sm border border-slate-200 group-hover:border-sky-600 transition flex items-center justify-center gap-2"
              >
            ...
            {/* Card 2: Trainer */}
            <div className="group bg-slate-50 hover:bg-white rounded-2xl p-8 border border-slate-200/80 hover:border-brand-300 shadow-soft hover:shadow-soft-lg transition-all duration-300 flex flex-col justify-between">
              <div>
                <div className="w-14 h-14 rounded-2xl bg-brand-100 text-brand-600 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <UserCheck className="w-7 h-7" />
                </div>
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-xl font-bold text-slate-900">Trainer</h3>
                  <span className="text-xs font-semibold text-brand-700 bg-brand-100 px-2.5 py-0.5 rounded-full">
                    Educator
                  </span>
                </div>
                <p className="text-brand-600 font-semibold text-sm mb-4">
              ...
              <button
                onClick={() => onNavigate('login')}
                className="w-full py-2.5 px-4 rounded-xl bg-white group-hover:bg-brand-600 text-slate-800 group-hover:text-white font-medium text-sm border border-slate-200 group-hover:border-brand-600 transition flex items-center justify-center gap-2"
              >
            ...
            {/* Card 3: Admin */}
            <div className="group bg-slate-50 hover:bg-white rounded-2xl p-8 border border-slate-200/80 hover:border-emerald-300 shadow-soft hover:shadow-soft-lg transition-all duration-300 flex flex-col justify-between">
              <div>
              ...
              <button
                onClick={() => onNavigate('login')}
                className="w-full py-2.5 px-4 rounded-xl bg-white group-hover:bg-emerald-600 text-slate-800 group-hover:text-white font-medium text-sm border border-slate-200 group-hover:border-emerald-600 transition flex items-center justify-center gap-2"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 relative">
            {[
              ...
              return (
                <div
                  key={st.step}
                  className="bg-white rounded-xl p-5 border border-slate-200/70 shadow-xs flex flex-col justify-between relative group hover:border-slate-300 transition"
                >
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-xs font-mono font-bold text-slate-400">{st.step}</span>
                      <div className={`p-2 rounded-lg border ${st.color}`}>
                        <Icon className="w-4 h-4" />
                      </div>
                    </div>
                    <h4 className="text-lg font-bold text-slate-900 mb-2">{st.title}</h4>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
            ...
            <button
              onClick={() => onNavigate('courses-browse')}
              className="mt-4 md:mt-0 inline-flex items-center gap-2 text-sm font-semibold text-brand-600 hover:text-brand-700 transition"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featuredCourses.map((c) => (
              <div
                key={c.id}
                className="bg-slate-50 rounded-2xl border border-slate-200/80 overflow-hidden shadow-soft hover:shadow-soft-lg hover:-translate-y-1 transition duration-200 flex flex-col justify-between"
              >
                <div>
                ...
                <div className="p-6 pt-0">
                  <button
                    ...
                    className="w-full py-2.5 px-4 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-medium text-xs transition text-center shadow-xs"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              ...
              return (
                <div
                  key={i}
                  className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-soft text-center flex flex-col items-center"
                >
      ...
      {/* ========================================================= */}
      {/* 6. FINAL CTA (PixelCanvas ONLY here with dark contrast)    */}
      {/* ========================================================= */}
      <section className="relative py-28 bg-slate-950 text-white overflow-hidden">
        {/* PixelCanvas exclusively integrated into the dark final CTA background */}
        <PixelCanvas
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-brand-900/60 text-brand-300 border border-brand-700/60 text-xs font-semibold uppercase tracking-wider mb-6">
