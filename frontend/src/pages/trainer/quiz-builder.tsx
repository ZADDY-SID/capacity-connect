      ...
      <div className="bg-white rounded-3xl p-8 border border-slate-200/80 shadow-soft">
        ...
        <div className="mt-6 flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <select
            ...
            className="px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-slate-800 focus:outline-none focus:border-brand-500"
          >
            {courses.map((c) => (
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-soft space-y-4">
            ...
            <div>
              ...
              <div className="flex justify-between text-[10px] text-slate-400 font-mono mt-1">
                <span>40%</span>
                <span>Passing Mark: {passingPercentage}%</span>
                <span>90%</span>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-soft space-y-6">
            <div className="flex items-center justify-between pb-4 border-b border-slate-100">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">Objective evaluation questions</p>
              </div>
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-brand-600 hover:bg-brand-700 text-white rounded-xl text-xs font-semibold transition shadow-xs"
              >
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-1">
                        <span className="text-xs font-semibold text-slate-500 px-2 py-0.5 rounded bg-white border border-slate-200">
                          {q.marks} marks
                        </span>
                        <button
                          onClick={() => {
          ...
          <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl border border-slate-100 p-6 space-y-4">
            ...
            <form onSubmit={handleSaveQuestion} className="space-y-3">
              ...
              <div className="space-y-2">
                <div>
                  <label className="block text-[11px] font-semibold text-slate-700">Option A</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-[11px] font-semibold text-slate-700">Option B</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-[11px] font-semibold text-slate-700">Option C</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-[11px] font-semibold text-slate-700">Option D</label>
                  <input
                    type="text"
                    required
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-brand-700 focus:outline-none focus:border-brand-500"
                  >
